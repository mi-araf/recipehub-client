...
const socialLinks = [
    { label: "Facebook", href: "https://www.facebook.com/mushfiq.araf.2024/", icon: FaFacebookF },
    { label: "Instagram", href: "https://www.instagram.com/tde_araf/", icon: FaInstagram },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/mi-araf/", icon: FaLinkedin },
    { label: "GitHub", href: "https://github.com/mi-araf", icon: FaGithub },
];
